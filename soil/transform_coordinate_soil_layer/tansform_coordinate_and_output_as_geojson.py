...
image=cv2.imread("soil.png")
dim_1_pixel_y=image.shape[0]
dim_2_pixel_x=image.shape[1]
x_init=150000 #圖片原點pixel的左上角
y_init=2855200 #圖片原點pixel的左上角
pixel_length=100
